...
import styles from "./HeedPage.module.css"; // 引入 SCSS 模組
  ...
  return (
    <div className={styles.heedContainer}>
      ...
      <div className={styles.contentSection}>
        ...
        <p>獲得 HEED 獎項的學校具備以下特點：</p>
        <ul>
          <li>致力於提升不同族裔、性別、宗教、社會經濟背景等學生的教育機會</li>
          <li>注重教職員隊伍的多元化建設</li>
          <li>提供支持弱勢群體的校園文化與學術環境</li>
          <li>持續推動多元性和包容性政策的發展</li>
        </ul>
        ...
        <ul>
          ...
          <li>教職員多元性： 確保教職員的多元化背景，促進文化交流與理解。</li>
          <li>
            包容性政策：
            制定並實施具體的多元化和包容性策略，營造公平的校園環境。
          </li>
          <li>社區參與： 促進與社區的合作，強化文化認同與社會責任。</li>
        </ul>

        <h2>伊利諾大學芝加哥分校 (UIC) 與 HEED</h2>
        <p>
          伊利諾大學芝加哥分校（University of Illinois Chicago, UIC） 是 HEED
          獎項的常勝軍，近年來多次榮獲此殊榮。
        </p>
        <p>UIC 在提升校園多元性、包容性和公平性方面的努力，包括：</p>
        <ul>
          <li>擁有全美最具多元性的學生群體之一</li>
          <li>實施多元化課程，提升學生對全球文化的理解</li>
          <li>提供針對弱勢群體的學術與心理支持服務</li>
          <li>建立多元文化中心與包容性資源中心</li>
        </ul>
