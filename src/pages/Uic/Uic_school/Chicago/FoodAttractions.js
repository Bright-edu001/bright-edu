  ...
  return (
    <div className="food-attractions-page">
      <ImageTextSection
        title="芝加哥城市"
        subtitle="景點 • 美食"
        imageUrl="/media/Chicago/Chicago_foodattraction/Stamp-collecting-amico.png" // 圖片路徑
        imageAlt="景點 • 美食"
      />
      ...
      <section className="attractions-section">
        <section className="food-attractions-intro">
          ...
          <img
            src="/media/Chicago/Chicago_foodattraction/5.png"
            alt="畢卡索雕像"
          />
        </section>
        ...
        <InfoCard
          ...
          imageSrc="/media/Chicago/Chicago_foodattraction/4.png"
          imageAlt="菲爾德自然史博物館"
          isRightImage={true}
        />
        ...
        <InfoCard
          ...
          imageSrc="/media/Chicago/Chicago_foodattraction/3.png"
          imageAlt="芝加哥美術館"
          isRightImage={false}
        />
        ...
        <InfoCard
          ...
          imageSrc="/media/Chicago/Chicago_foodattraction/2.png"
          imageAlt="千禧公園的人臉噴泉"
          isRightImage={true}
        />
        ...
        <InfoCard
          ...
          imageSrc="/media/Chicago/Chicago_foodattraction/1.png"
          imageAlt="大豆子"
          isRightImage={false}
        />
      </section>
      ...
      <section className="food-section">
        <h4 className="title">美食</h4>
        <h4 className="title">Deep dish pizza</h4>
        ...
        <InfoCard
          ...
          imageSrc="/media/Chicago/Chicago_foodattraction/pizza.png"
        ...
        <InfoCard
          ...
          imageSrc="/media/Chicago/Chicago_foodattraction/hotdog.png"
        ...
        <InfoCard
          ...
          imageSrc="/media/Chicago/Chicago_foodattraction/popcorn.png"
