      ...
      <SectionContainer>
        ...
        <section className="attractions-section">
          <InfoCard
            ...
            content={{
              first:
                "芝加哥市內保存著早期傳統式的歐洲古典建築，又有相當壯觀的現代摩天大樓，加上各種新奇形狀的裝置藝術為色彩多變的街頭雕塑的點綴，使整個芝加哥市成為建築藝術博物館。在市中心的戴利廣場，有一座藝術大師畢卡索所打造的造型奇特的金屬雕塑矗立在戴利中心前，因未命名，則當地人則直接稱之為「畢卡索」。",
              second:
                "雕塑高15公尺，重達162噸，於1967年8月15日落成。曾有數千人在此見證這座芝加哥市中心最早的大型戶外公共藝術品揭幕。 據畢卡索的孫子2004年接受《芝加哥太陽報》採訪時稱，雕塑是因一位名叫琳蒂婭．考比（Lydia Corbett）的法國女孩而得到靈感的。雕塑的曲線表現出對稱、流暢、柔和感，使人對於此雕塑有女性化的感覺。",
              third:
