      ...
      <SectionContainer>
        <section className="chicago-intro">
          <div className="container">
            ...
            <p className="intro-text">
              芝加哥是美國最重要的文化科教中心之一，擁有多間頂尖大學，伊利諾大學香檳分校、伊利諾學芝加哥分校，芝加哥大學等。地處於伊利諾州東北部，密西根湖西南端。大市區由庫克等6縣組成，周圍包括許多城鎮以及印第安那州西北濱湖地區諸城，面積為1,2061.6平方公里。以芝加哥為中心向外延伸480公里範圍內，集中了全國近20％的人口。
            </p>
            <p className="intro-text">
