        ...
        <section className="faq-section">
          ...
          <div className="question-list">
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["q1"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("q1")}
              >
                <h3>申請到UIC商學院碩士申請需要準備哪些資料?</h3>
            ...
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["q2"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("q2")}
              >
                <h3>申請多久後可以等到結果?如何確定入學?</h3>
                <span className="toggle-icon">
            ...
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["q4"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("q4")}
              >
                <h3>一年制MBA或專業課程會很緊張嗎?</h3>
                <span className="toggle-icon">
        ...
        <section className="faq-section">
          ...
          <div className="question-list">
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["l1"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("l1")}
              >
                <h3>就讀UIC商學碩士每年需費用大約多少？</h3>
                <span className="toggle-icon">
                  {expandedQuestions["l1"] ? "−" : "+"}
                </span>
              </div>
              <div
                className={`answer ${
            ...
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["l2"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("l2")}
              >
                <h3>關於住宿問題?</h3>
                <span className="toggle-icon">
                  {expandedQuestions["l2"] ? "−" : "+"}
                </span>
              </div>
              <div
                className={`answer ${
            ...
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["l3"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("l3")}
              >
                <h3>芝加哥是否是安全的城市呢?</h3>
                <span className="toggle-icon">
                  {expandedQuestions["l3"] ? "−" : "+"}
                </span>
              </div>
              <div
                className={`answer ${
            ...
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["l4"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("l4")}
              >
                <h3>在UIC就讀商學碩士課程時的交通方式?</h3>
                <span className="toggle-icon">
                  {expandedQuestions["l4"] ? "−" : "+"}
                </span>
              </div>
              <div
                className={`answer ${
            ...
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["l5"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("l5")}
              >
                <h3>行前準備，生活用品該攜帶的東西?</h3>
                <span className="toggle-icon">
                  {expandedQuestions["l5"] ? "−" : "+"}
                </span>
              </div>
              <div
                className={`answer ${
        ...
        <section className="faq-section">
          ...
          <div className="question-list">
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["o1"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("o1")}
              >
                <h3>預期UIC一年制MBA的校友資源，口碑獲得會不會高?</h3>
                <span className="toggle-icon">
                  {expandedQuestions["o1"] ? "−" : "+"}
                </span>
              </div>
              <div
                className={`answer ${
            ...
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["o2"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("o2")}
              >
                <h3>
                  UIC一年制MBA課程是正規的碩士學位，與學校校兩年制MBA學位相等，畢業校友同屬一個等嗎?
                </h3>
                <span className="toggle-icon">
                  {expandedQuestions["o2"] ? "−" : "+"}
                </span>
              </div>
              <div
                className={`answer ${
            ...
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["o3"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("o3")}
              >
                <h3>預期UIC商學院碩士課程是否為STEM學位呢?</h3>
                <span className="toggle-icon">
                  {expandedQuestions["o3"] ? "−" : "+"}
                </span>
              </div>
              <div
                className={`answer ${
            ...
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["o4"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("o4")}
              >
                <h3>UIC商學碩士是否需要寫論文?</h3>
                <span className="toggle-icon">
                  {expandedQuestions["o4"] ? "−" : "+"}
                </span>
              </div>
              <div
                className={`answer ${
            ...
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["o5"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("o5")}
              >
                <h3>畢業後能否留在美國工作?</h3>
                <span className="toggle-icon">
                  {expandedQuestions["o5"] ? "−" : "+"}
                </span>
              </div>
              <div
                className={`answer ${
            ...
            <div className="faq-item">
              <div
                className={`question ${
                  expandedQuestions["o6"] ? "expanded" : ""
                }`}
                onClick={() => toggleQuestion("o6")}
              >
                <h3>被錄取的人之中，是否有多渠道是華人工作經驗豐富?</h3>
                <span className="toggle-icon">
                  {expandedQuestions["o6"] ? "−" : "+"}
                </span>
              </div>
              <div
                className={`answer ${
