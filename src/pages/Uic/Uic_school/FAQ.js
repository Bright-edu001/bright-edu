          ...
          <div className="question-list">
            <Accordion>
              ...
              >
                ...
                <p>
                  不過也不要太擔心，美國當地都可以方便買到冬天衣物喔，另外冬天時候，室內都是有充足的暖氣。
                </p>
                <p>
                  有機會可以看到滿天白雪的景色，會是留學期間相當美好的回憶喔。
                </p>
              </AccordionItem>
            </Accordion>
          </div>
          ...
          <div className="question-list">
            <Accordion>
              ...
              >
                <p>
                  筆試-
                  需要先閱讀一篇商業文章或經濟數據圖或者文章，然後回答一題相關的商業開放性問答題，學生需要用英文論述方式（英文作文）作答，字數大約一張A4，主要用意是看學生用英文書寫的表達能力。
                </p>
                <p>
                  面試-
                  教授會從美國來台灣做一對一面試，或從美國用Skype語音或視訊。面試問題是因教授而異，但基本上都會以學生個人背景提問，所以只要多練習說話的流暢度，誠實作答即可。
                </p>
                <p>
                  備註:
