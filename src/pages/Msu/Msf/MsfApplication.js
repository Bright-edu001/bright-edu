  ...
  return (
    <div className="msf-application">
      ...
      <div className="msf-application-list">
        <ul>
          <li>
            申請資格：申請者須持有認可教育機構頒發的四年制學士學位，累積 GPA 3.0
            或以上。
          </li>
          <li>工作經驗：Optional，應屆畢業生可申請。</li>
          <li>英文版履歷表 (CV)</li>
          <li>英文版學術陳述（Academic Statement）</li>
          <li>推薦信 (LOR)：共 2 封（其中至少 1 封 必須由曾修課的教授撰寫）</li>
        ...
        <p>
          申請者應修過以下或同等課程：MTH 124（微積分 I 概論，Survey of Calculus
          I）、STT 315（商業機率與統計導論，Introductory Probability and
          Statistics for Business）學生應完成相當於 MTH 124（微積分 I）和 STT
          315（商業入門機率與統計）的課程。
        </p>
        <span>
          ＊ 若申請者具備
