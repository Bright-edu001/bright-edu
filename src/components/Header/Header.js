...
function Header() {
  ...
  const checkEastLansingMenuPosition = useCallback(() => {
    ...
    console.log(
      "[Debug] checkEastLansingMenuPosition called. menuElement:",
      menuElement
    );
    if (menuElement) {
      if (dropdownStates.eastLansingSub) {
        ...
        const originallyHadSubmenuBelow =
          menuElement.classList.contains("submenu-below");
        ...
        console.log(
          `[Debug] Natural right (as if positioned to side): ${naturalRight}, Viewport width: ${viewportWidth}, Originally had .submenu-below: ${originallyHadSubmenuBelow}`
        );

        if (naturalRight > viewportWidth) {
          console.log(
            "[Debug] Natural position would overflow. Ensuring .submenu-below is present."
          );
          if (!originallyHadSubmenuBelow) {
          ...
          console.log(
            "[Debug] Natural position would not overflow. Ensuring .submenu-below is absent."
          );
        ...
        if (naturalRight > viewportWidth) {
          if (!menuElement.classList.contains("submenu-below")) {
            menuElement.classList.add("submenu-below");
            console.log(
              "[Debug] Added .submenu-below as it was missing and needed."
            );
          }
        } else {
          if (menuElement.classList.contains("submenu-below")) {
            menuElement.classList.remove("submenu-below");
            console.log(
              "[Debug] Removed .submenu-below as it was present but not needed."
            );
          }
        }
      } else {
        console.log(
          "[Debug] eastLansingSub is false. Removing .submenu-below if present."
        );
        if (menuElement.classList.contains("submenu-below")) {
          menuElement.classList.remove("submenu-below");
        }
